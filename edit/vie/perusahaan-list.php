<div class="main-banner">
  ...
  <div class="container filter-box">
    ...
    <hr />
    <form action="<?php echo base_url(); ?>Perusahaan/tipe" method="post">
    <div class="row">
      <div class="col-md-4">
    ...
    <a href="<?php echo base_url();?>perusahaan/detail"><div class="col-xs-12 company-item">
      <div class="row company-itemhead">
        ...
        <div class="col-md-9">
          ...
          <span style="color:#b0b0b0;"><?php echo $a['tipe'];?></span>  <span class="label-primary">Membutuhkan : <?php echo $a['barang_dibutuhkan'];?></span>
        </div>
