  ...
  <nav id="navigate" class="nav navbar navbar-default" style="margin-bottom:0px;">
    <div class="container" style="padding:0;">
      ...
      <div class="pull-right">
        <a href="<?php if($_SESSION['tipe_user'] == 'Bahan Baku') echo base_url('feed/penyedia/'); else echo base_url('feed/perusahaan/');?>"><button class="btn-utama" onclick="" style="margin-top:3px;"><i class="fa fa-2x fa-pencil inverse"></i></button></a>
  ...
  <div class="container">
      <?php foreach ($feed as $data) { ?>
          <div class="xol-xs-12 hub-item">
            <a href="<?php echo base_url('index.php/feed/feed_detail/').$data['id_post'];?>">
