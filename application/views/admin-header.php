  ...
  <aside class="main-sidebar">
    ...
    <!-- Sidebar Menu -->
      <ul class="sidebar-menu">
        ...
        <li><a href="<?= base_url('admin/posting');?>"><i class="fa fa-link"></i><span>Posting</span></a></li>
        <li><a href="<?= base_url('admin/bahan_baku');?>"><i class="fa fa-link"></i><span>Perusahaan Bahan Baku</span></a></li>
        <li><a href="<?= base_url('admin/manufaktur');?>"><i class="fa fa-link"></i><span>Perusahaan Manufaktur</span></a></li>
        <li><a href="<?= base_url('admin/kategori');?>"><i class="fa fa-link"></i><span>Kategori</span></a></li>
